...
namespace FoodInventory.Data
{
    public class UnitOfWork : IUnitOfWork, IDisposable
    {
        ...
        private GenericRepository<ProductPhoto> imageRepository;
        ...
        public GenericRepository<ProductPhoto> ImageRepository
        {
            get { return imageRepository ?? (imageRepository = new GenericRepository<ProductPhoto>(context)); }
        }
